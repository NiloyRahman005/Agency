                    ...
                    <div class="cm-content-body  publish-content form excerpt">
                        <div class="card-body">
                            <div class="avatar-upload d-flex align-items-center">
                                <form action="{{ route('admin.teamMemberPost') }}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            @forelse($teamMembers as $key=>$teams)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $teams->name }}</td>
                            <td>
                                @if (isset($teams->image) && file_exists(public_path($teams->image)))
                                    <img src="{{ asset($teams->image) }}" style="height: 200px;width:200px;"
                                        class="img-fluid" alt="">
                                @endif
                            </td>
                            <td>
                                <a href="{{ route('admin.teamMemberDelete', $teams->id) }}"
